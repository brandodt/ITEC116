  ...
  return (
    <div className="bg-dark-secondary rounded-lg p-6 h-fit flex flex-col">
      ...
      <div className="flex gap-3 mt-auto">
        <button className="bg-dark-input hover:bg-sky-700 hover:text-white text-[#00a2ff] px-4 py-2 rounded flex-1 transition-colors flex items-center justify-center">
          <Edit size={16} className="mr-2" /> Edit
        </button>
        <button className="bg-dark-input hover:bg-red-900 hover:bg-opacity-20 text-red-500 px-4 py-2 rounded flex-1 transition-colors flex items-center justify-center">
